function cardProvider() {
    ...
    let titleContent = document.createTextNode(sport[8].name);
    ...
    let birthDetails = document.createTextNode('He was born on ' + sport[8].birthDate + ' in ' +
        sport[8].birthPlace + ' , ' + [sport[8].country]);
    let family = document.createTextNode(' He is not maried and he is father of ' + sport[8].children);
    ...
    pAside.innerText = ' He is retired but played for ' + sport[8].Team + ' in ' +
        sport[8].competitionLeague + ' and has ' + sport[8].championships;
    ...
    linkTag.setAttribute("href", 'https://en.wikipedia.org/wiki/Ronaldinho');
    ...
    img.setAttribute('src', sport[8].picture);
    car.appendChild(img);
