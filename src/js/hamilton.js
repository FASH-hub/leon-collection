function cardProvider() {
    ...
    let titleContent = document.createTextNode(sport[0].name);
    ...
    let birthDetails = document.createTextNode('He was born on ' + sport[0].birthDate + ' in ' +
        sport[0].birthPlace + ' , ' + [sport[0].country]);
    let family = document.createTextNode(' He is ' + sport[0].spouse +
        'and has' + sport[0].children);
    ...
    pAside.innerText = ' He races for ' + sport[0].Team + ' in ' +
        sport[0].competitionLeague + ' and has ' + sport[0].championships;
    ...
    linkTag.setAttribute("href", 'https://en.wikipedia.org/wiki/Lewis_Hamilton');
    ...
    img.setAttribute('src', sport[0].picture);
    car.appendChild(img);
