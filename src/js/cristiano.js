function cardProvider() {
    ...
    let titleContent = document.createTextNode(sport[2].name);
    ...
    pAside.innerText = ' He plays for ' + sport[2].Team + ' in ' +
        sport[2].competitionLeague + ' and has ' + sport[2].championships;
    ...
    linkTag.setAttribute("href", 'https://en.wikipedia.org/wiki/Cristiano_Ronaldo');
    ...
    img.setAttribute('src', sport[2].picture);
    car.appendChild(img);
