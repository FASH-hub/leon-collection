function cardProvider() {
    ...
    let titleContent = document.createTextNode(sport[7].name);
    ...
    let birthDetails = document.createTextNode('He was born on ' + sport[7].birthDate + ' in ' +
        sport[7].birthPlace + ' , ' + [sport[7].country]);
    let family = document.createTextNode(' He is maried with ' + sport[7].spouse +
        'and is a father of' + sport[7].children);
    ...
    pAside.innerText = ' He plays for ' + sport[7].Team + ' in ' +
        sport[7].competitionLeague + ' and has ' + sport[7].championships;
    ...
    linkTag.setAttribute("href", 'https://en.wikipedia.org/wiki/LeBron_James');
    ...
    img.setAttribute('src', sport[7].picture);
    car.appendChild(img);
