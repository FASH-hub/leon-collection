const sport = [{
        name: "Lewis Hamilton, F1 driver",
        picture: '../images/lh44.jpg',
        ...
        Team: 'Merceds AMG Patronas F1',
        championships: ' 7 championships ',
    },
    {
        name: "Kobe Bryant, american basketballer",
    ...
    {
        name: 'Cristiano Ronaldo, Portuguese footballer',
    ...
    {
        name: 'Serena Williams, american tennis player',
    ...
    {
        name: 'Lionel Messi, argentinean footballer',
    ...
    {
        name: 'Roger Federer, swiss tennis player',
    ...
    {
        name: "Lebron James, american basketballer",
    ...
    {
        name: 'Ronaldinho, brazilian footballer',
    ...
    {
        name: 'Rafael Nadal, spanish tennis player',
