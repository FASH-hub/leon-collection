function cardProvider() {
    ...
    let titleContent = document.createTextNode(sport[9].name);
    ...
    let birthDetails = document.createTextNode('He was born on ' + sport[9].birthDate + ' in ' +
        sport[9].birthPlace + ' , ' + [sport[9].country]);
    let family = document.createTextNode('He is married with ' + sport[9].spouse +
        ' and has ' + sport[9].children);
    ...
    pAside.innerText = ' He is till playing ' +
        sport[9].competitionLeague + ' and has already won ' + sport[9].championships;
    ...
    linkTag.setAttribute("href", 'https://en.wikipedia.org/wiki/Rafael_Nadal');
    ...
    img.setAttribute('src', sport[9].picture);
    car.appendChild(img);
