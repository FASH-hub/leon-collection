function cardProvider() {
    ...
    let birthDetails = document.createTextNode('He was born on ' + sport[5].birthDate + ' in ' +
        sport[5].birthPlace + ' , ' + [sport[5].country]);
    let family = document.createTextNode('He has a partner named ' + sport[5].spouse +
        ' and he is father of ' + sport[5].children);
    ...
    pAside.innerText = ' He is retired and has ' + sport[5].championships;
